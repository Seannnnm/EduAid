<template>
                ...
                <v-list density="compact">
                  <v-list-item prepend-icon="mdi-map-marker" class="mb-2">
                    ...
                    <v-list-item-subtitle
                      >123 Seama, Suite 300, Cooltown, FT 12345</v-list-item-subtitle
                    >
                  </v-list-item>
                  ...
                  <v-list-item prepend-icon="mdi-email" class="mb-2">
                    ...
                    <v-list-item-subtitle>contact@eduaid.com</v-list-item-subtitle>
                  </v-list-item>
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        'You can contact us via e-mail or call the phone number located on our "Contact Us" page during the allocated time periods.',
    },
    {
    ...
    {
      question: 'How can I follow up on my request?',
      answer:
        'Once applied you can check for a response in your e-mail inbox within 2-3 business days.',
    },
    {
      question: 'What payment methods do you accept?',
      answer:
        'We accept all major credit cards, debit cards, digital wallets, and in some locations, cash on payment in our main offices .',
    },
  ]
